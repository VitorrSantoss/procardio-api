...
import br.com.procardio.api.procardio_api.dtos.ConsultaAgendadaEvent;
...
public class ConsultaService {
    ...
    public Consulta salvarConsulta(Consulta consulta) {
        Optional<Consulta> consultaExistente = consultaRepository
                .findByMedico_IdAndDataHora(consulta.getMedico().getId(), consulta.getDataHora());
    ...
    public List<Consulta> buscarConsultasPorMedicoEPeriodo(Long medicoId, LocalDateTime dataInicio,
